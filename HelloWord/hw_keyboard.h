...
public:
    ...
    enum KeyCode_t : int16_t
    {
        ...
        PLAY_PAUSE,SCAN_PREVIOUS_TRACK,SCAN_NEXT_TRACK,CALCULATOR,MEDIA_SELECT,WWW_HOME,MAIL,
    ...
    int16_t keyMap[5][IO_NUMBER] = {
        ...
        {ESC,APPLICATION,WWW_HOME,MAIL,MEDIA_SELECT,SCAN_PREVIOUS_TRACK,SCAN_NEXT_TRACK,PLAY_PAUSE,F8,VOLUME_UP,VOLUME_DOWN,MUTE,CALCULATOR,PAUSE,
         GRAVE_ACCENT,NUM_1,NUM_2,NUM_3,NUM_4,NUM_5,NUM_6,NUM_7,NUM_8,NUM_9,NUM_0,MINUS,EQUAL,BACKSPACE,INSERT,
         TAB,Q,W,E,R,T,Y,U,I,O,P,LEFT_U_BRACE,RIGHT_U_BRACE,BACKSLASH,DELETE,
