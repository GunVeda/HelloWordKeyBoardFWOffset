...
public:
    ...
    static const uint16_t HID_REPORT_SIZE = KEY_REPORT_SIZE + RAW_REPORT_SIZE + MEDIA_REPORT_SIZE;
    ...
    enum KeyCode_t : int16_t
    {
        ...
        PLAY_PAUSE,SCAN_PREVIOUS_TRACK,SCAN_NEXT_TRACK,CALCULATOR,MEDIA_SELECT,WWW_HOME,MAIL,SYS_BRI_UP,SYS_BRI_DOWN,
        FN = 1000,TP1,TP2,TP3,TP4,TP5,TP6,FN_TP1,FN_TP2,FN_TP3,FN_TP4,FN_TP5,FN_TP6,
    ...
    int16_t keyMap[5][IO_NUMBER] = {
        ...
        {ESC,APPLICATION,WWW_HOME,MAIL,MEDIA_SELECT,SCAN_PREVIOUS_TRACK,SCAN_NEXT_TRACK,PLAY_PAUSE,STOP,VOLUME_DOWN,VOLUME_UP,MUTE,CALCULATOR,PAUSE,
         GRAVE_ACCENT,NUM_1,NUM_2,NUM_3,NUM_4,NUM_5,NUM_6,NUM_7,NUM_8,NUM_9,NUM_0,MINUS,EQUAL,BACKSPACE,INSERT,
         TAB,Q,W,E,R,T,Y,U,I,O,P,LEFT_U_BRACE,RIGHT_U_BRACE,BACKSLASH,DELETE,
         PAD_NUM_LOCK,A,S,D,F,G,H,J,K,L,SEMI_COLON,QUOTE,ENTER,PAGE_UP,
         LEFT_SHIFT,Z,X,C,V,B,N,M,COMMA,PERIOD,SLASH,RIGHT_SHIFT,UP_ARROW,PAGE_DOWN,
         LEFT_CTRL,LEFT_GUI,LEFT_ALT,SPACE,RIGHT_ALT,FN,RIGHT_CTRL,LEFT_ARROW,DOWN_ARROW,RIGHT_ARROW,
         FN_TP1,FN_TP2,FN_TP3,FN_TP4,FN_TP5,FN_TP6
        }
    };
